Public Class Desenho
    ...
    Private Sub btn_imprimir_Click(sender As Object, e As EventArgs) Handles btn_imprimir.Click
        ...
        Using frm = New TelaImpressao(Ordem.COD_FORM, Ordem.txt_desc.Text, Ordem.txt_pos.Text, Ordem.txt_fer.Text, Ordem.txt_resp.Text, Ordem.txt_dt_ini.Text, Ordem.txt_dt_ent.Text, Ordem.txt_sub_conta.Text, Ordem.txt_conta.Text, Ordem.txt_secao.Text, Ordem.txt_qtd.Text, Ordem.txt_tp.Text, Ordem.txt_caixa.Text, dt, txt_caminhadaimagem.Text)
            frm.ShowDialog()
        End Using
        Close()
    End Sub
